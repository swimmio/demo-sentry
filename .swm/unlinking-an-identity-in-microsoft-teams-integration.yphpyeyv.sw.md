...
# Getting the pre-install client
...
The function `build_group_actions` builds the group actions. Depending on the status of the group, it sets up the resolve, ignore, and assign actions.
